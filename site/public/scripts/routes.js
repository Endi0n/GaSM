...
export const DUMPSTERS_STATS_LIST_ROUTE = (start, end, lastId, order) => BASE_API_ROUTE + `/dumpsters/stats/list?dateStart=${start}&dateEnd=${end}&lastId=${lastId}&order=${order}`
